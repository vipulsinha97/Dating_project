          ...
          <form class="form-horizontal">
            <div class="card-body">
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputtitle" placeholder="Event title">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                    <input type="time" class="form-control" id="eventtimestartid">
                  </div>
                  <label for="eventtimeend" class="col-sm-2 col-form-label">Event End Time</label>
                  <div class="col-sm-4">
                    <input type="time" class="form-control" id="eventtimeendid">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="ticketid" placeholder="Ticket title">
                  </div>
                </div>
