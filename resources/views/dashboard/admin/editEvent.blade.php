            ...
            <form action="{{route('editCurrentEvent')}}" class="form-horizontal" method="POST" enctype="multipart/form-data">
              ...
              <div class="card-body">
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <select name="location" class="form-control">
                      ...
                      <option value="{{$data->location}}" selected>{{$data->location_name}}</option>
                      @else
                ...
                <div class="form-group row">
                  <label for="ticket" class="col-sm-2 col-form-label">Ticket Price</label>
                  <div class="col-sm-10">
                    <input type="text" name="gst_percentage" value="{{$data->gst_percentage}}" class="form-control" id="gst" placeholder="GST">
