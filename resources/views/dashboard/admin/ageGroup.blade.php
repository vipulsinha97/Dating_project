            ...
            <div class="content">
                ...
                <div class="row">
                    ...
                    @endif
                        ...
                        <h3 class="card-title">AGE GROUP TABLE</h3>
                        ...
                        <table class="table table-hover text-nowrap">
                            ...
                            <tr>
                                ...
                                <td>{{$ag->starting_age}}</td>
                                <td>{{$ag->ending_age}}</td>
                                <td>
                                  <a href="{{ URL::to('/admin/dashboard/editAgeGroup/') }}/{{$ag->id}}" class="btn btn-primary">Edit</a>
                                  {{-- <a href="{{ URL::to('/admin/dashboard/delete-ageGroup/') }}/{{$ag->id}}" class="btn btn-danger">Delete</a> --}}
                                </td>
                            </tr>    
                            @endforeach
                            </tbody>
