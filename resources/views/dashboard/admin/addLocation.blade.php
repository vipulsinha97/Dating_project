      ...
      <div class="content">
        <div class="container-fluid">
          ...
          <div class="card card-info">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{route('newLocation')}}" class="form-horizontal" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="location" value="{{old('location')}}" id="inputtitle" placeholder="Location Name">
